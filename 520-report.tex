...
platform applications that have not been made full use of in the computer
network industry. The aim of this project has been to use these technologies to
produce an improved implementation of a network map that effectively
communicates topology and performance data to its users. The development of such
map has involved assessing HTML5 technologies, identifying important features of
network maps, researching relevant information visualisation theory and
developing working prototypes. Representing computer networks in particular can
get difficult when the number of nodes and links is large. Visualisation
techniques have been identified and made use of that are effective in addressing
the scalability of displays, such as semantic zooming and layout grouping. This,
along with an expressive way of displaying network bandwidth has made for
improved presentation of network map displays. For this project, a network
mapping tool called NetMapJs was implemented to address weaknesses in current
tools. Network maps for two operational networks were developed which received
good feedback from the engineers in those organisations.
